/**
 * Veteran Status Section - Staff Demographics (Section 3.3)
 * VEVRAA Compliance Context
...
export function StaffVeteranStatusSection() {
  ...
  return (
    <CollapsibleSection
      ...
      badge={<VoluntaryBadge context="vevraa" />}
      defaultExpanded={false}
    >
      <div className="space-y-4">
        <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
          This information is collected for VEVRAA (Vietnam Era Veterans' Readjustment Assistance Act)
          compliance and to ensure equal employment opportunities for veterans. Providing this information
          is voluntary.
        </div>
        ...
        {showMilitaryDetails && (
          <div className="pl-6 border-l-2 border-green-200 space-y-3">
            <Badge variant="outline" className="mb-2 bg-green-50">Military Service Details</Badge>
