/**
 * Identity & Gender Section - Learner Demographics (Section 4.1)
 * Title IX Context
...
export function LearnerIdentityGenderSection() {
  ...
  return (
    <CollapsibleSection
      ...
      badge={<VoluntaryBadge context="title-ix" />}
      defaultExpanded={false}
    >
      <div className="space-y-4">
        <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
          This information is collected for Title IX compliance and to ensure a safe, inclusive campus
          environment. Providing this information is voluntary and confidential.
        </div>
